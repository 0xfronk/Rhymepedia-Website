...
app.post("/", async (req, res) => {
    ...
    const results = await axios.get(encodeURI(`https://rhymepedia-api.herokuapp.com/api/search/${search_input}`))
...
app.post("/create/:title/:artist", async (req, res) => {
    ...
    console.log(data)
    axios.post("https://rhymepedia-api.herokuapp.com/api/create", data)
